...
class Channel {
  ...
  factory Channel.fromJson(Map<String, dynamic> json) {
    ...
    Map<String, dynamic> latestVideos = json['latestVideos'];
    for(int i = 0; i < (latestVideos.length < videosToFetch ? latestVideos.length : videosToFetch); i++)
    {
    ...
    return Channel(
      name: json['author'],
      id: json['authorId'],
      pfp: json['authorBanners'][resolutionIndex]['url'],
