...
import 'package:off_the_hook/widgets/playing-now/video-controls-bar.dart';
import 'package:off_the_hook/widgets/playing-now/video-playing.dart';
...
Future<ChewieController> getVideoController(String vidURL) async {
  ...
  final chewieController = ChewieController(
      materialProgressColors: ChewieProgressColors(
          backgroundColor: Colors.transparent, playedColor: Colors.blue),
    ...
    return Column(children: [
      ...
      Expanded(
          child: SingleChildScrollView(
              ...
              child: Text(
                videoDescription,
                style: generalTextStyle(18, FontWeight.w600, 1),
              ))),
      Text("You're one of $views viewers",
          style: generalTextStyle(16, FontWeight.w500, 1)),
