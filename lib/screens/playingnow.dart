...
class _PlayingNowState extends State<PlayingNow> {  
  ...
  Widget build(BuildContext context) {
    double videoWidth = MediaQuery.of(context).size.width*.95;
        ...
        Row(
          ...
          children: [
            SizedBox(
              ...
              height: videoHeight,
              child: FutureBuilder(future: getPlayingVideoData(), builder: (context, snapshot) 
              {
                if(snapshot.hasData) {
...
/*
 _controller.value.isInitialized ? AspectRatio(aspectRatio: _controller.value.aspectRatio,child: VideoPlayer(_controller),): Text("Loading.."),
