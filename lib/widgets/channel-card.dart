            ...
            Container(
              child: Column(
                ...
                children: [
                  Text(
                    name,
                    style: generalTextStyle(videoTitleSize-2, FontWeight.w700, 1),
                  ),
                  Text(
                    description, 
                    overflow: TextOverflow.ellipsis, 
                    style: generalTextStyle(smallTextSize, FontWeight.w500, .8),
                  )
                ],
              ),
            ),  
        ...
        child: Row(
          children: [
            ...
            const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                SizedBox(width: 95, height:12,child: ColoredBox(color: Colors.white60)),
                SizedBox(height:10),
                SizedBox(width: 120, height:8,child: ColoredBox(color: Colors.white60)),
              ],
            ),
          ], 
        )
