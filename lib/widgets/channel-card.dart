        ...
        child: GestureDetector(
          onTap: () async => await Navigator.of(context).push(MaterialPageRoute(
              builder: (context) => Scaffold(
                    ...
                    body: ChannelProfile(description: description, id: id, isAutoGenerated: isAutoGenerated, isFamilyFriendly: isFamilyFriendly, name: name, pfp: pfp, latestVideosIDs: latestVideosIDs, subCount: subCount),
                  ))),
          child: Row(
            children: [
              ClipRRect(
